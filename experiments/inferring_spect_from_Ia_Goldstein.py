...
all_data = np.load("../data/goldstein_processed/preprocessed_midfilt_3.npz")
#breakpoint()
...
#breakpoint()
with open(f'../ckpt/pretrain_photometrycond_static_dict_param_cross_attn_Ia_goldstein_centered', 'rb') as f:
...
n_samples = 50
#posterior_samples = []
phase_cond = np.array([0.0 ] * n_samples * n_test_data)
...
np.savez(f"../samples/posterior_test_photometrycond_first{n_test_data}_Ia_Goldstein_centered.npz", 
